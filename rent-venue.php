            ...
            <div class="row">
                <div class="col-lg-12">
                    <div class="row" id="tabs">
                                    ...
                                    <div class="row">
                                        <div class="col-lg-9">
                                            <div class="right-content">
                                                ...
                                                <p>ArtXibition Event Template is brought to you by Tooplate website and it included total 7 php pages. 
                        ...
                        <br><br>If you need the latest php templates, you may visit <a href="https://www.toocss.com/" target="_blank">Too CSS</a> website that features a great collection of templates in different categories.</p>
                                                <ul class="list">
                    ...
                    <div class="col-xl-4 col-lg-4 col-md-6 mb-30">
                        <div class="footer-widget">
                            ...
                            <ul>
                                ...
                                <li><a href="show-events.php">Shows & Events</a></li>
