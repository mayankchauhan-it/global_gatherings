                                                ...
                                                <div class="col-lg-12">
                                                    <div class="event-item">
                                                        <div class="row">
                                                            <div class="col-lg-4">
                                                                <div class="left-content">
                                                                    <h4>Sharad Poonam Garba Night</h4>
                                                                    <p>"Join us for Shard Poonam Garba Night—a night of vibrant dance and joyful celebration, bringing the spirit of tradition to life."</p>
                                                                    <div class="main-dark-button"><a href="event-details.php">Discover More</a></div>
                                                                </div>
                                                            </div>
                                                            <div class="col-lg-4">
                                                                <div class="thumb">
                                                                    <img src="assets/images/sharad_poonam.jpg" alt="">
                                                                </div>
                                                            </div>
                                                            <div class="col-lg-4">
                                                                <div class="right-content">
                                                                    <ul>
                                                                        <li>
                                                                            <i class="fa fa-clock-o"></i>
                                                                            <h6>Oct 16 Wednsday<br>10:00 PM - 12:30 AM</h6>
                                                                        </li>
                                                                        <li>
                                                                            <i class="fa fa-map-marker"></i>
                                                                            <span> <p>132 Feet Ring Road, University Area, Vastrapur, Ahmedabad, Gujarat<p></span>
                                                                        </li>
                                                                        <!-- <li>
                                                ...
                                                <div class="col-lg-12">
                                                    <div class="event-item">
                                                        <div class="row">
                                                            <div class="col-lg-4">
                                                                <div class="left-content">
                                                                    <h4>Super Rock DJ Night</h4>
                                                                    <p>"Get ready to rock and roll all night long—DJ style!"</p>
                                                                    <div class="main-dark-button"><a href="event-details.php">Discover More</a></div>
                                                                </div>
                                                            </div>
                                                            <div class="col-lg-4">
                                                            ...
                                                            <div class="col-lg-4">
                                                                <div class="right-content">
                                                                    <ul>
                                                                        <li>
                                                                            <i class="fa fa-clock-o"></i>
                                                                            <h6>Nov 16 Saturday<br>09:30 AM - 12:30 PM</h6>
                                                                        </li>
                                                                        <li>
                                                                            <i class="fa fa-map-marker"></i>
                                                                            <span><p>Sunburn Arena Ft. Martin Garrix, Nirvana Party Lawn,,Ahmedabad,Gujarat<p>></span>
                                                                        </li>
                                                                        <!-- <li>
                                                                            <i class="fa fa-users"></i>
                                                        ...
                                                        <div class="row">
                                                            <div class="col-lg-4">
                                                                <div class="left-content">
                                                                    ...
                                                                    <p>“Festive fun and Christmas cheer inside!🎄🎉”</p>
                                                                    <div class="main-dark-button"><a href="event-details.php">Discover More</a></div>
                                                                </div>
                                                            </div>
                                                            <div class="col-lg-4">
                                                                <div class="thumb">
                                                                    <img src="assets/images/jesus.jpg" alt="">
                                                                </div>
                                                            </div>
                                                            <div class="col-lg-4">
                                                                <div class="right-content">-
                                                                    <ul>
                                                                        <li>
                                                                            <i class="fa fa-clock-o"></i>
                                                                            <h6>Dec 25 Wednesday<br>10:00 PM - 12:00 AM</h6>
                                                                        </li>
                                                                        <li>
                                                                            <i class="fa fa-map-marker"></i>
                                                                            <span><p>Hill Rd, Near Balaji Restaurant, Ranwar, Bandra West, Mumbai,Maharashtra</p></span>
                                                                        </li>
                                                                        <!-- <li>
                                                                            <i class="fa fa-users"></i>
                                                ...
                                                <div class="col-lg-12">
                                                    <div class="event-item">
                                                        <div class="row">
                                                            <div class="col-lg-4">
                                                                <div class="left-content">
                                                                    <h4>The Ultimate 2024 Sendoff</h4>
                                                                    <p>Cheer's to 2024’s Happy Highlights and Joyful Achievements</p>
                                                                    <div class="main-dark-button"><a href="event-details.php">Discover More</a></div>
                                                                </div>
                                                            </div>
                                                            <div class="col-lg-4">
                                                            ...
                                                            <div class="col-lg-4">
                                                                <div class="right-content">
                                                                    <ul>
                                                                        <li>
                                                                            <i class="fa fa-clock-o"></i>
                                                                            <h6>Dec 31 Tuesday<br>10:00 PM - 12:30 AM</h6>
                                                                        </li>
                                                                        <li>
                                                                            <i class="fa fa-map-marker"></i>
                                                                            <span><p>Yashwant Smart City, Vasai East, Vasai-Virar, Mumbai, Maharashtra</p></span>
                                                                        </li>
                                                                        <!-- <li>
                                                                            <i class="fa fa-users"></i>
